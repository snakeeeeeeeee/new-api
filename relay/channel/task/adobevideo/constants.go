...
var (
	...
	supportedModels = map[string]videoCapability{
		...
		"kling_3.0_720p":         stableCapability("kling-3.0", 3, 15, nil, map[string]int{"frame": 2}, map[string]int{"frame": 1}),
		"kling_3.0_1080p":        stableCapability("kling-3.0", 3, 15, nil, map[string]int{"frame": 2}, map[string]int{"frame": 1}),
