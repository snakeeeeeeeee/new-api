...
func ImageHelper(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.NewAPIError) {
	...
	forceXAIImageEditConversion := info.ChannelType == constant.ChannelTypeXai && info.RelayMode == relayconstant.RelayModeImagesEdits
	if !forceXAIImageEditConversion && info.PriceData.ImagePricing == nil && (model_setting.GetGlobalSettings().PassThroughRequestEnabled || info.ChannelSetting.PassThroughBodyEnabled) {
