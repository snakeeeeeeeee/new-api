...
type UserAggregateGroupRouteModelRatioOverride struct {
...
type UserSetting struct {
	...
	AggregateGroupRouteModelRatioOverrides []UserAggregateGroupRouteModelRatioOverride `json:"aggregate_group_route_model_ratio_overrides,omitempty"` // 用户级聚合子分组模型倍率
