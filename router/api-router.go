...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminMenuAuth("channel"))
		{
			...
			channelRoute.GET("/model_discovery/:type", controller.GetChannelModelDiscoveryCapability)
		...
		taskRoute := apiRouter.Group("/task")
		{
			...
			taskRoute.GET("/async/tasks", middleware.AdminAuth(), middleware.AdminMenuAuth("async_task"), controller.GetAdminAsyncTasks)
			taskRoute.GET("/async/webhook-deliveries", middleware.AdminAuth(), middleware.AdminMenuAuth("async_task"), controller.GetAdminWebhookDeliveries)
			taskRoute.GET("/async/webhook-deliveries/:delivery_id", middleware.AdminAuth(), middleware.AdminMenuAuth("async_task"), controller.GetAdminWebhookDelivery)
			taskRoute.POST("/async/webhook-deliveries/:delivery_id/retry", middleware.AdminAuth(), middleware.AdminMenuAuth("async_task"), controller.RetryAdminWebhookDelivery)
