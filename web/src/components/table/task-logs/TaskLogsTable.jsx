...
const TaskLogsTable = (taskLogsData) => {
  ...
  }, [t, COLUMN_KEYS, copyText, openContentModal, openVideoModal, openAudioModal, updateTaskBlockStatus, showUserInfoFunc, isAdminUser]);
  ...
  return (
    <CardTable
      ...
      rowKey='key'
      loading={loading}
      scroll={compactMode ? undefined : { x: 1800 }}
