...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&AggregateGroupCategory{}, "AggregateGroupCategory"},
		{&AggregateGroup{}, "AggregateGroup"},
		{&AggregateGroupTarget{}, "AggregateGroupTarget"},
		{&AggregateGroupRouteModelRatio{}, "AggregateGroupRouteModelRatio"},
		{&Setup{}, "Setup"},
		{&TwoFA{}, "TwoFA"},
...
func migrateLOGDB() error {
	var err error
	if err = LOG_DB.AutoMigrate(&Log{}, &ErrorSnapshot{}); err != nil {
		return err
	}
	return nil
}
