...
func Distribute() func(c *gin.Context) {
	return func(c *gin.Context) {
				...
				if preferredChannelID, found := service.GetPreferredChannelByAffinity(c, modelRequest.Model, usingGroup); found {
					...
					if err == nil && preferred != nil {
						if preferred.Status != common.ChannelStatusEnabled {
							...
							userGroup := common.GetContextKeyString(c, constant.ContextKeyUserGroup)
							userSetting, _ := common.GetContextKeyType[dto.UserSetting](c, constant.ContextKeyUserSetting)
							autoGroups := service.GetUserAutoGroupWithSetting(userGroup, userSetting)
		...
		if channel != nil && c.Writer != nil && c.Writer.Status() < http.StatusBadRequest &&
			!common.GetContextKeyBool(c, constant.ContextKeyClaudeStreamIncomplete) {
...
func getModelRequest(c *gin.Context) (*ModelRequest, bool, error) {
	...
	} else if c.Request.Method == http.MethodPost && c.Request.URL.Path == "/v1/image/tasks" && strings.Contains(strings.ToLower(c.Request.Header.Get("Content-Type")), "multipart/form-data") {
